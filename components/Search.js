  ...
  return (
    <form className=" relative mx-60 my-10">
      <div className=" w-full relative flex">
        ...
        />
        <button onClick={submitHandler} type='submit' className=" text-lg text-slate-50 font-semibold absolute  right-0 border-none bg-slate-500 hover:bg-slate-600  rounded-tr-full rounded-br-full py-[0.55rem] px-[4rem]">Search</button>
      </div>
    </form>
  );
};
